    ...
    public class ArchiverController : Controller
    {
        ...
        public ActionResult ApplicationPost(ArchiverApplicationViewModel archiverApplicationViewModel)
        {
            ...
            try
            {
                ...
                archiverApplicationViewModel.Results.addDetails("Fichier archivé sur le serveur : " + filePath + " (" + QlikUtils.Utilitaires.FileSizeMo(filePath) + "Mo) &nbsp&nbsp&nbsp&nbsp <a href=\"file:///" + fileDirectory + "\">>Ouvrir le répertoire</a>");
